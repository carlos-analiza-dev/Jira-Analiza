...
import eliminarComentario from "@/api/comentariosTasks/eliminarComentario";
import { useState } from "react";
import actualizarComentario from "@/api/comentariosTasks/actualizarComentario";
...
const Comentarios = ({ comentarios, setComentarios }: Props) => {
