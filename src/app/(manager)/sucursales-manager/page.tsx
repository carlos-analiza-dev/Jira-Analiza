...
const SucursalesManager = () => {
  ...
  const onSubmit = async (data: SucursalData) => {
    if (!paisStatus) {
      toast({
        title: "Debes seleccionar el pais al que pertenece la sucursal.",
        variant: "destructive",
      });
      return;
    }
            ...
            <AlertDialogContent>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mt-5 mb-5">
                  <label className="text-custom-title font-semibold dark:text-white ">
                    Nombre de Sucursal
                  </label>
                  <Input
                    autoFocus
                ...
                <div className="mt-2 mb-4 w-full">
                  <label className="block font-semibold text-custom-title dark:text-white">
                    Pais
                  </label>
