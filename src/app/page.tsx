...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex justify-center items-center bg-gray-50 dark:bg-gray-900">
      {isLoading && (
        <div className="absolute inset-0 z-50 flex justify-center items-center bg-gray-900 bg-opacity-50">
          <div role="status">
            <svg
              aria-hidden="true"
      ...
      <div
        className={`grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 sm:w-full ${isLoading ? "opacity-50" : ""}`}
      >
